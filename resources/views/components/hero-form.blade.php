<div class="max-w-2xl mx-auto bg-white rounded-md px-4 py-2">
    <form action="{{ route('container-bl-tracking') }}" method="GET">
        ...
        <div id="myTabContent">
            <div class="px-4 py-2 rounded-lg" id="schedule" role="tabpanel" aria-labelledby="schedule-tab">
                <label for="container_number" class="inline-block mb-2">Container Number or BL Number</label>
                <div class="relative w-full d-flex align-items-center mb-2">
                    ...
                    <input id="container_number" name="container_number" placeholder="Container Number or BL Number" required type="text" 
